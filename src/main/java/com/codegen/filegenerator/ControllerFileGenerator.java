...
public class ControllerFileGenerator implements IFileGenerator {

	private static final String TEMPLATE_NAME = "controller.vm";
	
	private static final String FILE_CHILD_DIR = "controller";
	...
	public ControllerFileGenerator(ICodeGenContext context) {
