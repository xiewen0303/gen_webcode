...
public class DaoImplFileGenerator implements IFileGenerator {

	private static final String TEMPLATE_NAME = "daoImpl.vm";
	
	private static final String FILE_CHILD_DIR_1 = "dao";
	
	private static final String FILE_CHILD_DIR_2 = "impl";
	...
	public DaoImplFileGenerator(ICodeGenContext context) {
	...
	private void initialize(){
		...
		packageDirs.addAll(FileUtil.getDirs(FILE_CHILD_DIR_1));
		packageDirs.add(codeGenContext.getModelName());
		packageDirs.addAll(FileUtil.getDirs(FILE_CHILD_DIR_2));
