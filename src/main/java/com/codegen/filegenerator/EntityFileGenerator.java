...
public class EntityFileGenerator implements IFileGenerator {

	private static final String TEMPLATE_NAME = "entity.vm";
	
	private static final String FILE_CHILD_DIR = "entity";
	...
	public EntityFileGenerator(ICodeGenContext context) {
