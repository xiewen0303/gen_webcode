...
public class ServiceFileGenerator implements IFileGenerator {

	private static final String TEMPLATE_NAME = "service.vm";
	
	private static final String FILE_CHILD_DIR = "service";
	...
	public ServiceFileGenerator(ICodeGenContext context) {
