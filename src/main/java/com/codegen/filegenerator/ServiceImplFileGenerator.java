...
public class ServiceImplFileGenerator implements IFileGenerator {

    private static final String TEMPLATE_NAME = "serviceImpl.vm";
	
	private static final String FILE_CHILD_DIR_1 = "service";
	...
	public ServiceImplFileGenerator(ICodeGenContext context) {
	...
	private void initialize(){
		...
		packageDirs.add(FILE_CHILD_DIR_1);
		packageDirs.add(codeGenContext.getModelName());
		packageDirs.add(FILE_CHILD_DIR_2);
