...
public class VoFileGenerator implements IFileGenerator {

	private static final String TEMPLATE_NAME = "vo.vm";
	
	private static final String FILE_CHILD_DIR = "vo";
	...
	public VoFileGenerator(ICodeGenContext context) {
